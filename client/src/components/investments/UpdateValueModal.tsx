  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl p-6">
        ...
        <h3 className="text-sm font-semibold text-slate-900 dark:text-zinc-100">Update current value</h3>
        <p className="text-xs text-slate-500 dark:text-zinc-500 mt-1.5">
          Mark the latest market value for <span className="text-slate-700 dark:text-zinc-300">{investment.assetName}</span>.
        </p>

        <form onSubmit={handleSubmit} className="mt-4">
          <label htmlFor="updateCurrentValue" className="text-xs font-medium text-slate-500 dark:text-zinc-400 mb-2 block">
            Current value
          </label>
          <input
            ...
            className="w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-lg px-3.5 py-2.5 text-sm text-slate-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-amber-600/50 dark:focus:ring-amber-500/50 focus:border-amber-600/50 dark:focus:border-amber-500/50"
          />
