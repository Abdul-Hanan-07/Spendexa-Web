    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-zinc-950">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-5/12 relative overflow-hidden flex-col justify-between p-12 bg-gradient-to-br from-amber-50 via-white to-teal-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-black border-r border-slate-200 dark:border-zinc-800">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 -left-16 w-80 h-80 rounded-full bg-amber-300/40 dark:bg-amber-500/20 blur-3xl animate-[orb-drift-1_13s_ease-in-out_infinite]" />
          <div className="absolute top-1/3 -right-24 w-96 h-96 rounded-full bg-orange-300/30 dark:bg-orange-500/15 blur-3xl animate-[orb-drift-2_16s_ease-in-out_infinite]" />
          <div className="absolute -bottom-24 left-1/4 w-80 h-80 rounded-full bg-teal-300/40 dark:bg-teal-500/15 blur-3xl animate-[orb-drift-3_14s_ease-in-out_infinite]" />
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl shadow-black/10 dark:shadow-black/40 border border-slate-200 dark:border-zinc-800 p-8 animate-[fade-in-up_300ms_ease-out]">
