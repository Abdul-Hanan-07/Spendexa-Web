  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-zinc-900 rounded-2xl shadow-xl shadow-black/20 border border-zinc-800 p-8">
          <h1 className="text-xl font-semibold text-zinc-100 mb-6 text-center">{title}</h1>
          {children}
        </div>
      </div>
    </div>
