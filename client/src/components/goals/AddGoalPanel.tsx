    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative h-full w-full max-w-md bg-white dark:bg-zinc-900 border-l border-slate-200 dark:border-zinc-800 flex flex-col">
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-200 dark:border-zinc-800 shrink-0">
          <h2 className="text-sm font-semibold text-slate-900 dark:text-zinc-100">Add goal</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
            <div>
              <label htmlFor="name" className="text-xs font-medium text-slate-500 dark:text-zinc-400 mb-2 block">
                Goal name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="targetAmount" className="text-xs font-medium text-slate-500 dark:text-zinc-400 mb-2 block">
                Target amount
              </label>
              <input
                id="targetAmount"
            ...
            <div>
              <label htmlFor="deadline" className="text-xs font-medium text-slate-500 dark:text-zinc-400 mb-2 block">
                Deadline
              </label>
              <input
                id="deadline"
