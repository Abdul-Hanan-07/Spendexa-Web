...
import { LayoutDashboard, ArrowLeftRight, TrendingUp, Landmark, Wallet, Target, FileBarChart, X, Info } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between px-5 h-16 border-b border-slate-200 dark:border-zinc-800 shrink-0">
          ...
          <button
            ...
            className="md:hidden -mr-2.5 w-11 h-11 flex items-center justify-center text-slate-500 dark:text-zinc-400 hover:text-slate-800 dark:hover:text-zinc-200 hover:bg-slate-100 dark:hover:bg-zinc-800/60 rounded-lg transition-colors"
          >
            <X size={20} />
          </button>
        </div>
